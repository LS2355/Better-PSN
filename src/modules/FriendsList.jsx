...
function FriendTemplate(Props) {
  ...
  return(
    <div className="col-lg-4 top-index" onClick={()=>showPopup(index)}>
      <div className="item row">
         ...
         */}
         ...
         {PSPlus == 1 && (<img className="ps-plus" src="https://seeklogo.com/images/P/playstation-plus-logo-5DBDF15160-seeklogo.com.png" alt="PS+ logo" />)}
         <br />
         { personalDetails ?
            (<div>
        ...
        div.col-lg-2
          ...
          {/* online status */}
            <li> {status} <div className= {`friendsList__status details__status-${status}`}>
            <div className="test__gn"></div>
            </div></li>
    ...
    return(
        ...
        <div className="row">
          ...
          <div className="col-lg-12">
            <div className="main-button friendsList__expand-container" onClick={()=>Props.setExpandList(!Props.expandList)}><a href="#sum">Down arrow</a></div>
          </div>
        </div>
      </div>
    )
